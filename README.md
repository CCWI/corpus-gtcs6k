...
On this page we provide the data set for the corpus on German topic classification and success (GTCS6k), which was first presented on the [25th IEEE FRUCT conference](https://fruct.org/conference25) (FRUCT' 25) along with a work in progress paper. Details can be found in the section [Citation](#citation) below.
